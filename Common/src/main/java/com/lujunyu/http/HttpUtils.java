...
public class HttpUtils {
	...
	private static final CloseableHttpClient HTTPCLIENT = HttpClients.createMinimal(new MultiThreadHttpConnectionManager());
	 ...
	 * @throws Exception
	 */
	public static <T> T send(String url, HttpMethodType methodType,HttpDataType dataType, Class<T> clazz, Map<String, Object> headers,Object param) throws Exception {
	...
	private static <T> T buildResp(String url, CloseableHttpResponse response, Class<T> clazz, HttpDataType dataType,Map<String, Object> headers) throws Exception {
...
//	TODO
	 ...
	 */
	private static void addHeaders(Map<String, Object> headers, HttpRequestBase httpRequestBase,HttpMethodType methodType) {
