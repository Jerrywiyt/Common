...
class Question5 {
  public static void main(String args[]) {
    ...
    System.out.println(
        question5.longestPalindrome3(
            ""));
    System.out.println(
        question5.longestPalindrome4(
            ""));
    System.out.println(
        question5.longestPalindrome5(
            ""));
  }
   ...
   * 最长公共子字符串方案。
   *
   * <p>arr[i][j] = arr[i-1][j-1] + 1;
   *
   * <p>使用最长公共子字符串的方法解不开此题，比如：s=“abc534cba”，实际结果是a，但是此方法返回abc。 所以需要在原有逻辑上增加判断 子字符串是否是回文的逻辑。
   */
  ...
  /**
   * 动态规划。 状态转移方程 p[i,j] = p[i+1,j-1]&&S[i]==S[j];
   *
   * <p>采用备忘录方法缓存中间结果。
   *
   * <p>时间复杂度o2.
  ...
  private String longestPalindrome3(String s) {
    ...
    for (int len = 1; len <= s.length(); len++) {
      ...
      for (int start = 0; start < s.length() - len + 1; start++) {
        ...
        cache[start][end] =
            (len == 1 || len == 2 || cache[start + 1][end - 1]) && s.charAt(start) == s.charAt(end);
