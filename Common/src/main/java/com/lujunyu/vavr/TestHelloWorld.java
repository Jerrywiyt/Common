...
public class TestHelloWorld {
  ...
  /**
   * Function 普通函数 CheckFunction 可以抛异常的函数。
   *
   * <p>compose的特性是将多个function组合成一个新的function。
   */
  @Test
  ...
  public void testFunctionPartial() {
    Function5<Integer, Integer, Integer, Integer, Integer, Integer> multiply =
  ...
  /** 函数科里化。 函数科里化操作是把多值参数的函数转变为只有一个参数的函数。 */
  @Test
  public void testFunctionCurrying() {
    ...
    Function1<Integer, Function1<Integer, Function1<Integer, Function1<Integer, Integer>>>>
        curried1 = add4.curried();
  ...
  public void testOption() {
    ...
    Option<String> maybenull =
        option.flatMap(s -> Option.of((String) null)).map(String::toUpperCase);
    System.out.println(maybenull.isEmpty());
  }

  /** Try是对函数的异常进行一个柔性处理。可方便使用者处理异常。 Try一般把CheckFunction进行包装。 */
  @Test
  public void testTry() {
