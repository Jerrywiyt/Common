...
public class WebSocketServerHandler extends SimpleChannelInboundHandler<Object> {
    ...
    private void handle(ChannelHandlerContext ctx, FullHttpRequest msg) {
        ...
        WebSocketServerHandshakerFactory ws = new WebSocketServerHandshakerFactory("ws://localhost:8080/websocket",null,false);
    ...
    private void handle(ChannelHandlerContext ctx, WebSocketFrame msg) {
        ...
        ctx.channel().writeAndFlush(new TextWebSocketFrame(request+"，欢迎使用websocket，now="+new Date().toString()));
    }
