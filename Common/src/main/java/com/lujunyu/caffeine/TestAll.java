...
public class TestAll {
    /**
     * Caffeine的reload不同于Guava cache，它本身就是异步的，默认线程池是ForkJoinPool.commonPool，可以通过executor(Executor)方法进行指定线程池。guava cache的异步需要在reload方法中指定线程池。
     */
    @Test
    ...
    public void testWriter(){
        LoadingCache<String,String> cache = Caffeine.newBuilder()
                ...
                .writer(new CacheWriter<String, String>() {
                    ...
                    @Override
                    public void delete(@NonNull String s, @Nullable String s2, @NonNull RemovalCause removalCause) {
