...
public class TestEviction {
  ...
  public void testSize() {
    LoadingCache<String, String> graphs1 =
        Caffeine.newBuilder().maximumSize(10_000).build(this::load);

    // Evict based on the number of vertices in the cache
    LoadingCache<String, String> graphs2 =
        Caffeine.newBuilder()
  ...
  public void testTime() {
    ...
    LoadingCache<Key, Graph> graphs1 =
        Caffeine.newBuilder()
            .expireAfterAccess(5, TimeUnit.MINUTES)
            .build(key -> createExpensiveGraph(key));
    LoadingCache<Key, Graph> graphs2 =
        Caffeine.newBuilder()
            ...
            .expireAfter(
                new Expiry<Key, Graph>() {
                  ...
                  public long expireAfterUpdate(
                      Key key, Graph graph, long currentTime, long currentDuration) {
  ...
  public void testReffer() {
    ...
    LoadingCache<Key, Graph> graphs =
        Caffeine.newBuilder().weakKeys().weakValues().build(key -> createExpensiveGraph(key));
